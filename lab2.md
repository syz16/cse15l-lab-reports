...
<img src="./img/lab2-add-message-1.png" alt="Added a message using /add-message?s=Hello&user=jpolitz" width="600"/>

<img src="./img/lab2-chat-1.png" alt="Chat after adding message 1" width="500"/>
...
<img src="./img/lab2-add-message-2.png" alt="Added a message using /add-message?s=How are you&user=yash" width="600"/>

<img src="./img/lab2-chat-2.png" alt="Chat after adding message 2" width="500"/>
...
**Private** key on my computer: `/Users/sophiazhu/.ssh/id_rsa`

<img src="./img/lab2-local-keys.png" alt="local ssh key files are in .ssh directory" width="400"/>

**Public** key on `ieng6` remote server: `/home/linux/ieng6/oce/8o/soz007/.ssh/authorized_keys`

<img src="./img/lab2-remote-keys.png" alt="remote ssh key files are in .ssh directory" width="300"/>

This screenshot shows that I can log in without entering my password:

<img src="./img/lab2-ieng6-login.png" alt="logging in to ieng6 through Terminal" width="800"/>
